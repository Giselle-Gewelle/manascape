...
public class Class50_Sub1_Sub4_Sub5 extends Class50_Sub1_Sub4
{
            ...
            boolean flag, int k1, int l1)
    {
        ...
        if(i != -1)
        {
            ...
            anInt1730 = 0;
            anInt1729 = Client.currentTime - 1;
    ...
    public Model getRotatedModel()
    {
        ...
        {
            int j = Client.currentTime - anInt1729;
            ...
            anInt1729 = Client.currentTime - j;
            if(aClass14_1724 != null)
        ...
        {
            Model class50_sub1_sub4_sub4 = class47.method431(anInt1721, anInt1722, anInt1715, anInt1716, anInt1717, anInt1718, i);
