...
public class Class21 {
	...
	public static void method236(byte abyte0[], boolean flag) {
		...
		byteStream.position = abyte0.length - 8;
		int i = byteStream.getUnsignedShort();
		int j = byteStream.getUnsignedShort();
		int k = byteStream.getUnsignedShort();
		if(!flag)
			return;
		int l = byteStream.getUnsignedShort();
		int i1 = 0;
		ByteBuffer byteStream_1 = new ByteBuffer(abyte0);
		byteStream_1.position = i1;
		i1 += i + 2;
		ByteBuffer byteStream_2 = new ByteBuffer(abyte0);
		byteStream_2.position = i1;
		i1 += j;
		ByteBuffer byteStream_3 = new ByteBuffer(abyte0);
		byteStream_3.position = i1;
		i1 += k;
		ByteBuffer byteStream_4 = new ByteBuffer(abyte0);
		byteStream_4.position = i1;
		i1 += l;
		ByteBuffer byteStream_5 = new ByteBuffer(abyte0);
		byteStream_5.position = i1;
		Class41 class41 = new Class41(byteStream_5, 0);
		int j1 = byteStream_1.getUnsignedShort();
		int ai[] = new int[500];
		int ai1[] = new int[500];
		int ai2[] = new int[500];
		int ai3[] = new int[500];
		for(int k1 = 0; k1 < j1; k1++) {
			int l1 = byteStream_1.getUnsignedShort();
			Class21 class21 = aClass21Array430[l1] = new Class21();
			class21.anInt431 = byteStream_4.getUnsignedByte();
			class21.aClass41_432 = class41;
			int i2 = byteStream_1.getUnsignedByte();
			int j2 = -1;
			int k2 = 0;
			for(int l2 = 0; l2 < i2; l2++) {
				int i3 = byteStream_2.getUnsignedByte();
				if(i3 > 0) {
