...
public class Class29
{
    ...
    public void method308(byte byte0, ByteBuffer byteStream)
    {
        anInt579 = byteStream.getUnsignedByte();
        if(byte0 == 6)
            byte0 = 0;
        else
            throw new NullPointerException();
        anInt577 = byteStream.getInt();
        anInt578 = byteStream.getInt();
        method309(byteStream, 0);
    }

    public void method309(ByteBuffer byteStream, int i)
    {
        anInt574 = byteStream.getUnsignedByte();
        ...
        {
            anIntArray575[j] = byteStream.getUnsignedShort();
            anIntArray576[j] = byteStream.getUnsignedShort();
        }
