...
public class Model extends Class50_Sub1_Sub4 {
	...
	public static void method575(byte abyte0[], int i, byte byte0) {
		...
		byteStream.position = abyte0.length - 18;
		Class26 class26_1 = aClass26Array1682[i] = new Class26();
		class26_1.aByteArray533 = abyte0;
		class26_1.anInt534 = byteStream.getUnsignedShort();
		class26_1.anInt535 = byteStream.getUnsignedShort();
		class26_1.anInt536 = byteStream.getUnsignedByte();
		...
		int k1 = byteStream.getUnsignedShort();
		int l1 = byteStream.getUnsignedShort();
		int i2 = byteStream.getUnsignedShort();
		int j2 = byteStream.getUnsignedShort();
		int k2 = 0;
	...
	public Model(int i, int j) {
		...
		ByteBuffer byteStream = new ByteBuffer(class26.aByteArray533);
		byteStream.position = class26.anInt537;
		ByteBuffer byteStream_1 = new ByteBuffer(class26.aByteArray533);
		byteStream_1.position = class26.anInt538;
		ByteBuffer byteStream_2 = new ByteBuffer(class26.aByteArray533);
		byteStream_2.position = class26.anInt539;
		if(j >= 0)
			aBoolean1641 = !aBoolean1641;
		ByteBuffer byteStream_3 = new ByteBuffer(class26.aByteArray533);
		byteStream_3.position = class26.anInt540;
		ByteBuffer byteStream_4 = new ByteBuffer(class26.aByteArray533);
		byteStream_4.position = class26.anInt541;
		int k = 0;
		int l = 0;
		int i1 = 0;
		for(int j1 = 0; j1 < anInt1648; j1++) {
			...
			int i2 = 0;
			if((k1 & 1) != 0)
				i2 = byteStream_1.method534();
			int k2 = 0;
			if((k1 & 2) != 0)
				k2 = byteStream_2.method534();
			int i3 = 0;
			if((k1 & 4) != 0)
				i3 = byteStream_3.method534();
			...
			if(anIntArray1676 != null)
				anIntArray1676[j1] = byteStream_4.getUnsignedByte();
		}

		byteStream.position = class26.anInt544;
		byteStream_1.position = class26.anInt545;
		byteStream_2.position = class26.anInt546;
		byteStream_3.position = class26.anInt547;
		byteStream_4.position = class26.anInt548;
		for(int l1 = 0; l1 < anInt1652; l1++) {
			anIntArray1662[l1] = byteStream.getUnsignedShort();
			if(anIntArray1659 != null)
				anIntArray1659[l1] = byteStream_1.getUnsignedByte();
			if(anIntArray1660 != null)
				anIntArray1660[l1] = byteStream_2.getUnsignedByte();
			if(anIntArray1661 != null)
				anIntArray1661[l1] = byteStream_3.getUnsignedByte();
			if(anIntArray1677 != null)
				anIntArray1677[l1] = byteStream_4.getUnsignedByte();
		}

		byteStream.position = class26.anInt542;
		byteStream_1.position = class26.anInt543;
		int j2 = 0;
		int l2 = 0;
		int j3 = 0;
		int k3 = 0;
		for(int l3 = 0; l3 < anInt1652; l3++) {
			int i4 = byteStream_1.getUnsignedByte();
			if(i4 == 1) {
				j2 = byteStream.method534() + k3;
				k3 = j2;
				l2 = byteStream.method534() + k3;
				k3 = l2;
				j3 = byteStream.method534() + k3;
				k3 = j3;
		...
		byteStream.position = class26.anInt549;
		for(int j4 = 0; j4 < anInt1664; j4++) {
			anIntArray1665[j4] = byteStream.getUnsignedShort();
			anIntArray1666[j4] = byteStream.getUnsignedShort();
			anIntArray1667[j4] = byteStream.getUnsignedShort();
		}

	}

	public Model(int i, Model aclass50_sub1_sub4_sub4[]) {
		anInt1636 = 932;
		anInt1637 = 426;
		aBoolean1638 = false;
		aBoolean1639 = true;
	...
	public Model(boolean flag, boolean flag1, int i, Model class50_sub1_sub4_sub4) {
		...
		anIntArray1666 = class50_sub1_sub4_sub4.anIntArray1666;
		anIntArray1667 = class50_sub1_sub4_sub4.anIntArray1667;
		super.modelHeight = ((Class50_Sub1_Sub4) (class50_sub1_sub4_sub4)).modelHeight;
	...
	public void method598(int i, int j, int k, int l, int i1, int j1, int k1) {
		int l1 = Rasterizer.anInt1532;
		int i2 = Rasterizer.anInt1533;
	...
	public void method560(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2) {
		...
		if(k3 / i3 >= DrawingArea.anInt1432)
			return;
		int l3 = j3 + anInt1671 << 9;
		if(l3 / i3 <= -DrawingArea.anInt1432)
			return;
		int i4 = k1 * k - j2 * j >> 16;
		int j4 = anInt1671 * j >> 16;
		int k4 = i4 + j4 << 9;
		if(k4 / i3 <= -DrawingArea.anInt1433)
			return;
		int l4 = j4 + (super.modelHeight * k >> 16);
		int i5 = i4 - l4 << 9;
		if(i5 / i3 >= DrawingArea.anInt1433)
			return;
		...
		if(i2 > 0 && aBoolean1705) {
			...
			int i6 = anInt1706 - Rasterizer.anInt1532;
			int k6 = anInt1707 - Rasterizer.anInt1533;
		...
		int l5 = Rasterizer.anInt1532;
		int j6 = Rasterizer.anInt1533;
		int l6 = 0;
		int i7 = 0;
		if(i != 0) {
			l6 = anIntArray1710[i];
			...
			if(anIntArray1659 == null || anIntArray1659[k] != -1) {
				...
				if(flag && (i3 == -5000 || l3 == -5000 || k4 == -5000)) {
					...
					if((i3 - l3) * (anIntArray1687[j2] - anIntArray1687[k1]) - (anIntArray1687[l] - anIntArray1687[k1]) * (k4 - l3) > 0) {
						...
						if(i3 < 0 || l3 < 0 || k4 < 0 || i3 > DrawingArea.anInt1431 || l3 > DrawingArea.anInt1431 || k4 > DrawingArea.anInt1431)
	...
	public void method600(int i) {
		...
		Rasterizer.aBoolean1528 = aBooleanArray1684[i];
		if(anIntArray1661 == null)
			Rasterizer.anInt1531 = 0;
		else
			Rasterizer.anInt1531 = anIntArray1661[i];
		int i1;
		if(anIntArray1659 == null)
			i1 = 0;
		else
		...
		if(i1 == 0) {
			Rasterizer.method503(anIntArray1687[j], anIntArray1687[k], anIntArray1687[l], anIntArray1686[j], anIntArray1686[k], anIntArray1686[l], anIntArray1656[i], anIntArray1657[i],
					anIntArray1658[i]);
			return;
		}
		if(i1 == 1) {
			Rasterizer.method505(anIntArray1687[j], anIntArray1687[k], anIntArray1687[l], anIntArray1686[j], anIntArray1686[k], anIntArray1686[l], anIntArray1712[anIntArray1656[i]]);
			return;
		}
		if(i1 == 2) {
			...
			Rasterizer.method507(anIntArray1687[j], anIntArray1687[k], anIntArray1687[l], anIntArray1686[j], anIntArray1686[k], anIntArray1686[l], anIntArray1656[i], anIntArray1657[i],
					anIntArray1658[i], anIntArray1689[l1], anIntArray1689[j2], anIntArray1689[l2], anIntArray1690[l1], anIntArray1690[j2], anIntArray1690[l2], anIntArray1691[l1], anIntArray1691[j2],
					anIntArray1691[l2], anIntArray1662[i]);
			return;
		}
		if(i1 == 3) {
			...
			Rasterizer.method507(anIntArray1687[j], anIntArray1687[k], anIntArray1687[l], anIntArray1686[j], anIntArray1686[k], anIntArray1686[l], anIntArray1656[i], anIntArray1656[i],
					anIntArray1656[i], anIntArray1689[i2], anIntArray1689[k2], anIntArray1689[i3], anIntArray1690[i2], anIntArray1690[k2], anIntArray1690[i3], anIntArray1691[i2], anIntArray1691[k2],
					anIntArray1691[i3], anIntArray1662[i]);
		}
	}

	public void method601(int i) {
		int j = Rasterizer.anInt1532;
		int k = Rasterizer.anInt1533;
		int l = 0;
		...
		if((j3 - j4) * (k7 - j7) - (i7 - j7) * (j5 - j4) > 0) {
			Rasterizer.aBoolean1528 = false;
			if(l == 3) {
				if(j3 < 0 || j4 < 0 || j5 < 0 || j3 > DrawingArea.anInt1431 || j4 > DrawingArea.anInt1431 || j5 > DrawingArea.anInt1431)
					Rasterizer.aBoolean1528 = true;
				int l7;
				if(anIntArray1659 == null)
					l7 = 0;
				else
				...
				if(l7 == 0)
					Rasterizer.method503(i7, j7, k7, j3, j4, j5, anIntArray1701[0], anIntArray1701[1], anIntArray1701[2]);
				else if(l7 == 1)
					Rasterizer.method505(i7, j7, k7, j3, j4, j5, anIntArray1712[anIntArray1656[i]]);
				else if(l7 == 2) {
					int j8 = anIntArray1659[i] >> 2;
					int k9 = anIntArray1665[j8];
					int k10 = anIntArray1666[j8];
					int k11 = anIntArray1667[j8];
					Rasterizer.method507(i7, j7, k7, j3, j4, j5, anIntArray1701[0], anIntArray1701[1], anIntArray1701[2], anIntArray1689[k9], anIntArray1689[k10], anIntArray1689[k11],
							anIntArray1690[k9], anIntArray1690[k10], anIntArray1690[k11], anIntArray1691[k9], anIntArray1691[k10], anIntArray1691[k11], anIntArray1662[i]);
				} else if(l7 == 3) {
					int k8 = anIntArray1659[i] >> 2;
					int l9 = anIntArray1665[k8];
					int l10 = anIntArray1666[k8];
					int l11 = anIntArray1667[k8];
					Rasterizer.method507(i7, j7, k7, j3, j4, j5, anIntArray1656[i], anIntArray1656[i], anIntArray1656[i], anIntArray1689[l9], anIntArray1689[l10], anIntArray1689[l11],
							anIntArray1690[l9], anIntArray1690[l10], anIntArray1690[l11], anIntArray1691[l9], anIntArray1691[l10], anIntArray1691[l11], anIntArray1662[i]);
				}
			}
			if(l == 4) {
				if(j3 < 0 || j4 < 0 || j5 < 0 || j3 > DrawingArea.anInt1431 || j4 > DrawingArea.anInt1431 || j5 > DrawingArea.anInt1431 || anIntArray1699[3] < 0
						|| anIntArray1699[3] > DrawingArea.anInt1431)
					Rasterizer.aBoolean1528 = true;
				int i8;
				if(anIntArray1659 == null)
					i8 = 0;
				...
				if(i8 == 0) {
					Rasterizer.method503(i7, j7, k7, j3, j4, j5, anIntArray1701[0], anIntArray1701[1], anIntArray1701[2]);
					Rasterizer.method503(i7, k7, anIntArray1700[3], j3, j5, anIntArray1699[3], anIntArray1701[0], anIntArray1701[2], anIntArray1701[3]);
					return;
				}
				if(i8 == 1) {
					int l8 = anIntArray1712[anIntArray1656[i]];
					Rasterizer.method505(i7, j7, k7, j3, j4, j5, l8);
					Rasterizer.method505(i7, k7, anIntArray1700[3], j3, j5, anIntArray1699[3], l8);
					return;
				}
				if(i8 == 2) {
					...
					Rasterizer.method507(i7, j7, k7, j3, j4, j5, anIntArray1701[0], anIntArray1701[1], anIntArray1701[2], anIntArray1689[i10], anIntArray1689[i11], anIntArray1689[i12],
							anIntArray1690[i10], anIntArray1690[i11], anIntArray1690[i12], anIntArray1691[i10], anIntArray1691[i11], anIntArray1691[i12], anIntArray1662[i]);
					Rasterizer.method507(i7, k7, anIntArray1700[3], j3, j5, anIntArray1699[3], anIntArray1701[0], anIntArray1701[2], anIntArray1701[3], anIntArray1689[i10],
							anIntArray1689[i11], anIntArray1689[i12], anIntArray1690[i10], anIntArray1690[i11], anIntArray1690[i12], anIntArray1691[i10], anIntArray1691[i11], anIntArray1691[i12],
							anIntArray1662[i]);
					return;
				}
				if(i8 == 3) {
					...
					Rasterizer.method507(i7, j7, k7, j3, j4, j5, anIntArray1656[i], anIntArray1656[i], anIntArray1656[i], anIntArray1689[j10], anIntArray1689[j11], anIntArray1689[j12],
					...
					Rasterizer.method507(i7, k7, anIntArray1700[3], j3, j5, anIntArray1699[3], anIntArray1656[i], anIntArray1656[i], anIntArray1656[i], anIntArray1689[j10],
							anIntArray1689[j11], anIntArray1689[j12], anIntArray1690[j10], anIntArray1690[j11], anIntArray1690[j12], anIntArray1691[j10], anIntArray1691[j11], anIntArray1691[j12],
							anIntArray1662[i]);
				}
			}
		}
	...
	public boolean fitsOnSingleTile;
	...
	static {
		anIntArray1710 = Rasterizer.anIntArray1536;
		anIntArray1711 = Rasterizer.anIntArray1537;
		anIntArray1712 = Rasterizer.anIntArray1548;
		anIntArray1713 = Rasterizer.anIntArray1535;
	}
}
