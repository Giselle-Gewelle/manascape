    ...
    implements Runnable
{
    ...
    public void run()
    {
        try
        {
            while(aBoolean1339) 
            {
                ...
                if(aClient1373.loggedIn && aSocket1355 != null && anOutputStream1349 != null && (anInt1341 > 0 || aClient1373.aClass23Array1228[0] == null))
                {
                    anInt1375++;
                    if(anInt1375 > 500)
                    {
    ...
    public void method335(CacheArchive class2, Client client1)
    {
        String as[] = {
        ...
        for(int k = 0; k < 4; k++)
        {
            byte abyte1[] = class2.getDataForName(as1[k]);
            int i1 = abyte1.length / 4;
            ByteBuffer byteStream_1 = new ByteBuffer(abyte1);
            anIntArrayArray1344[k] = new int[i1];
            for(int l1 = 0; l1 < i1; l1++)
                anIntArrayArray1344[k][l1] = byteStream_1.getInt();

        }

        byte abyte2[] = class2.getDataForName("model_index");
        ...
        abyte2 = class2.getDataForName("map_index");
        ...
        abyte2 = class2.getDataForName("anim_index");
        ...
        abyte2 = class2.getDataForName("midi_index");
        byteStream_2 = new ByteBuffer(abyte2);
        j1 = abyte2.length;
        ...
        try
        {
            if(aSocket1355 == null)
            {
                ...
                if(l - aLong1378 < 4000L)
                    return;
                aLong1378 = l;
                aSocket1355 = aClient1373.method32(43594 + Client.portOffset);
