...
public class ClientSocket implements Runnable {
	...
	public ClientSocket(byte byte0, Socket socket, GameApplet applet_sub1) throws IOException {
		aByte380 = 2;
		aBoolean384 = false;
		aBoolean389 = false;
		aBoolean390 = false;
	...
	public void method228(int i, int j, int k, byte abyte0[]) throws IOException {
		...
		if(aByteArray386 == null)
			aByteArray386 = new byte[SIZE];
		synchronized(this) {
			for(int l = 0; l < j; l++) {
				aByteArray386[anInt388] = abyte0[l + k];
				anInt388 = (anInt388 + 1) % SIZE;
				if(anInt388 == (anInt387 + 4900) % SIZE)
	...
	public GameApplet anApplet_Sub1_385;
