...
public class Signlink implements Runnable {
			...
			if(socketreq != 0) {
				...
				if(midiplay) {
					...
					try {
						...
						if(music.exists()) {
							midiSequence = MidiSystem.getSequence(music);
						}
	...
	public static String findcachedir() {
		/*
		 * String as[] = { "c:/windows/", "c:/winnt/", "d:/windows/",
		 * "d:/winnt/", "e:/windows/", "e:/winnt/", "f:/windows/", "f:/winnt/",
		 * "c:/", "~/", "/tmp/", "", "c:/rscache", "/rscache" }; if(storeid < 32
		 * || storeid > 34) storeid = 32; String s = ".file_store_" + storeid;
		 * for(int i = 0; i < as.length; i++) try { String s1 = as[i];
		 * if(s1.length() > 0) { File file = new File(s1); if(!file.exists())
		 * continue; } File file1 = new File(s1 + s); if(file1.exists() ||
		 * file1.mkdir()) return s1 + s + "/"; } catch(Exception _ex) { } return
		 * null;
		 */
		//return "./cache/.file_Store_32/";
		//return "C:/.manascape_file_store_32/";
		String s1 = "C:/.manascape_file_store_32/";
