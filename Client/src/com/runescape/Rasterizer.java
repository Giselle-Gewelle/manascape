...
public class Rasterizer extends DrawingArea {
	...
	public static void method493(int i) {
		i = 19 / i;
		lineOffsets = new int[DrawingArea.anInt1426];
		for(int j = 0; j < DrawingArea.anInt1426; j++)
			lineOffsets[j] = DrawingArea.width * j;

		anInt1532 = DrawingArea.width / 2;
		anInt1533 = DrawingArea.anInt1426 / 2;
	}
	...
	public static void method497(CacheArchive class2, int i) {
		if(i != -17551) {
			for(int j = 1; j > 0; j++)
				;
		}
	...
	public static int[] method500(int i) {
		...
		if(aBoolean1527) {
			...
			for(int i1 = 0; i1 < 4096; i1++) {
				int i2 = ai[i1] = ai1[class50_sub1_sub1_sub3.imgPixels[i1]] & 0xf8f8ff;
				if(i2 == 0)
			...
			if(class50_sub1_sub1_sub3.imgWidth == 64) {
				for(int j1 = 0; j1 < 128; j1++) {
					for(int j2 = 0; j2 < 128; j2++)
						ai[j2 + (j1 << 7)] = ai1[class50_sub1_sub1_sub3.imgPixels[(j2 >> 1) + ((j1 >> 1) << 6)]];

				}

			} else {
				for(int k1 = 0; k1 < 16384; k1++)
					ai[k1] = ai1[class50_sub1_sub1_sub3.imgPixels[k1]];
	...
	public static void method503(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2) {
		...
		if(i <= j && i <= k) {
			if(i >= DrawingArea.viewportBottom)
				return;
			if(j > DrawingArea.viewportBottom)
				j = DrawingArea.viewportBottom;
			if(k > DrawingArea.viewportBottom)
				k = DrawingArea.viewportBottom;
			if(j < k) {
				j1 = l <<= 16;
				i2 = k1 <<= 15;
				if(i < 0) {
				...
				if(i != j && j3 < j2 || i == j && j3 > l2) {
					...
					for(i = lineOffsets[i]; --j >= 0; i += DrawingArea.width) {
						method504(DrawingArea.pixels, i, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
						j1 += j3;
						l += j2;
						i2 += k3;
						k1 += k2;
					...
					while(--k >= 0) {
						method504(DrawingArea.pixels, i, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
						j1 += j3;
						i1 += l2;
						i2 += k3;
						l1 += i3;
				...
				j -= i;
				for(i = lineOffsets[i]; --j >= 0; i += DrawingArea.width) {
					method504(DrawingArea.pixels, i, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
					j1 += j3;
					l += j2;
					i2 += k3;
					k1 += k2;
				...
				while(--k >= 0) {
					method504(DrawingArea.pixels, i, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
					j1 += j3;
					i1 += l2;
					i2 += k3;
					l1 += i3;
			...
			if(i != k && j3 < j2 || i == k && l2 > j2) {
				...
				for(i = lineOffsets[i]; --k >= 0; i += DrawingArea.width) {
					method504(DrawingArea.pixels, i, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
					i1 += j3;
					l += j2;
					l1 += k3;
					k1 += k2;
			...
			k -= i;
			for(i = lineOffsets[i]; --k >= 0; i += DrawingArea.width) {
				method504(DrawingArea.pixels, i, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
				i1 += j3;
				l += j2;
				l1 += k3;
				k1 += k2;
		...
		if(j <= k) {
			...
			if(k < i) {
				...
				if(j != k && j2 < l2 || j == k && j2 > j3) {
					...
					for(j = lineOffsets[j]; --k >= 0; j += DrawingArea.width) {
						method504(DrawingArea.pixels, j, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
						l += j2;
						i1 += l2;
						k1 += k2;
						l1 += i3;
					...
					while(--i >= 0) {
						method504(DrawingArea.pixels, j, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
						l += j2;
						j1 += j3;
						k1 += k2;
						i2 += k3;
				...
				k -= j;
				for(j = lineOffsets[j]; --k >= 0; j += DrawingArea.width) {
					method504(DrawingArea.pixels, j, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
					l += j2;
					i1 += l2;
					k1 += k2;
					l1 += i3;
				...
				while(--i >= 0) {
					method504(DrawingArea.pixels, j, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
					l += j2;
					j1 += j3;
					k1 += k2;
					i2 += k3;
			...
			if(j2 < l2) {
				...
				for(j = lineOffsets[j]; --i >= 0; j += DrawingArea.width) {
					method504(DrawingArea.pixels, j, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
					j1 += j2;
					i1 += l2;
					i2 += k2;
					l1 += i3;
			...
			i -= j;
			for(j = lineOffsets[j]; --i >= 0; j += DrawingArea.width) {
				method504(DrawingArea.pixels, j, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
				j1 += j2;
				i1 += l2;
				i2 += k2;
				l1 += i3;
		...
		if(i < j) {
			...
			if(l2 < j3) {
				...
				for(k = lineOffsets[k]; --i >= 0; k += DrawingArea.width) {
					method504(DrawingArea.pixels, k, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
					i1 += l2;
					j1 += j3;
					l1 += i3;
					i2 += k3;
				...
				while(--j >= 0) {
					method504(DrawingArea.pixels, k, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
					i1 += l2;
					l += j2;
					l1 += i3;
					k1 += k2;
			...
			i -= k;
			for(k = lineOffsets[k]; --i >= 0; k += DrawingArea.width) {
				method504(DrawingArea.pixels, k, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
				i1 += l2;
				j1 += j3;
				l1 += i3;
				i2 += k3;
			...
			while(--j >= 0) {
				method504(DrawingArea.pixels, k, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
				i1 += l2;
				l += j2;
				l1 += i3;
				k1 += k2;
		...
		if(l2 < j3) {
			...
			for(k = lineOffsets[k]; --j >= 0; k += DrawingArea.width) {
				method504(DrawingArea.pixels, k, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
				l += l2;
				j1 += j3;
				k1 += i3;
				i2 += k3;
		...
		j -= k;
		for(k = lineOffsets[k]; --j >= 0; k += DrawingArea.width) {
			method504(DrawingArea.pixels, k, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
			l += l2;
			j1 += j3;
			k1 += i3;
			i2 += k3;
		...
		if(aBoolean1530) {
			...
			if(aBoolean1528) {
				if(i1 - l > 3)
					...
					l1 = 0;
				if(i1 > DrawingArea.anInt1431)
					i1 = DrawingArea.anInt1431;
				if(l < 0) {
					j1 -= l * l1;
					l = 0;
				}
	...
	public static void method505(int i, int j, int k, int l, int i1, int j1, int k1) {
		...
		if(i <= j && i <= k) {
			...
			if(j < k) {
				...
				if(i != j && j2 < l1 || i == j && j2 > i2) {
					...
					j -= i;
					for(i = lineOffsets[i]; --j >= 0; i += DrawingArea.width) {
						method506(DrawingArea.pixels, i, k1, 0, j1 >> 16, l >> 16);
						j1 += j2;
						l += l1;
					}

					while(--k >= 0) {
						method506(DrawingArea.pixels, i, k1, 0, j1 >> 16, i1 >> 16);
						j1 += j2;
						i1 += i2;
						i += DrawingArea.width;
					}
				...
				j -= i;
				for(i = lineOffsets[i]; --j >= 0; i += DrawingArea.width) {
					method506(DrawingArea.pixels, i, k1, 0, l >> 16, j1 >> 16);
					j1 += j2;
					l += l1;
				}

				while(--k >= 0) {
					method506(DrawingArea.pixels, i, k1, 0, i1 >> 16, j1 >> 16);
					j1 += j2;
					i1 += i2;
					i += DrawingArea.width;
				}
			...
			if(i != k && j2 < l1 || i == k && i2 > l1) {
				...
				k -= i;
				for(i = lineOffsets[i]; --k >= 0; i += DrawingArea.width) {
					method506(DrawingArea.pixels, i, k1, 0, i1 >> 16, l >> 16);
					i1 += j2;
					l += l1;
				}
			...
			k -= i;
			for(i = lineOffsets[i]; --k >= 0; i += DrawingArea.width) {
				method506(DrawingArea.pixels, i, k1, 0, l >> 16, i1 >> 16);
				i1 += j2;
				l += l1;
			}
		...
		if(j <= k) {
			...
			if(k < i) {
				...
				if(j != k && l1 < i2 || j == k && l1 > j2) {
					...
					k -= j;
					for(j = lineOffsets[j]; --k >= 0; j += DrawingArea.width) {
						method506(DrawingArea.pixels, j, k1, 0, l >> 16, i1 >> 16);
						l += l1;
						i1 += i2;
					}

					while(--i >= 0) {
						method506(DrawingArea.pixels, j, k1, 0, l >> 16, j1 >> 16);
						l += l1;
						j1 += j2;
						j += DrawingArea.width;
					}
				...
				k -= j;
				for(j = lineOffsets[j]; --k >= 0; j += DrawingArea.width) {
					method506(DrawingArea.pixels, j, k1, 0, i1 >> 16, l >> 16);
					l += l1;
					i1 += i2;
				}

				while(--i >= 0) {
					method506(DrawingArea.pixels, j, k1, 0, j1 >> 16, l >> 16);
					l += l1;
					j1 += j2;
					j += DrawingArea.width;
				}
			...
			if(l1 < i2) {
				...
				i -= j;
				for(j = lineOffsets[j]; --i >= 0; j += DrawingArea.width) {
					method506(DrawingArea.pixels, j, k1, 0, j1 >> 16, i1 >> 16);
					j1 += l1;
					i1 += i2;
				}
			...
			i -= j;
			for(j = lineOffsets[j]; --i >= 0; j += DrawingArea.width) {
				method506(DrawingArea.pixels, j, k1, 0, i1 >> 16, j1 >> 16);
				j1 += l1;
				i1 += i2;
			}
		...
		if(i < j) {
			...
			if(i2 < j2) {
				...
				i -= k;
				for(k = lineOffsets[k]; --i >= 0; k += DrawingArea.width) {
					method506(DrawingArea.pixels, k, k1, 0, i1 >> 16, j1 >> 16);
					i1 += i2;
					j1 += j2;
				}

				while(--j >= 0) {
					method506(DrawingArea.pixels, k, k1, 0, i1 >> 16, l >> 16);
					i1 += i2;
					l += l1;
					k += DrawingArea.width;
				}
			...
			i -= k;
			for(k = lineOffsets[k]; --i >= 0; k += DrawingArea.width) {
				method506(DrawingArea.pixels, k, k1, 0, j1 >> 16, i1 >> 16);
				i1 += i2;
				j1 += j2;
			}

			while(--j >= 0) {
				method506(DrawingArea.pixels, k, k1, 0, l >> 16, i1 >> 16);
				i1 += i2;
				l += l1;
				k += DrawingArea.width;
			}
		...
		if(i2 < j2) {
			...
			j -= k;
			for(k = lineOffsets[k]; --j >= 0; k += DrawingArea.width) {
				method506(DrawingArea.pixels, k, k1, 0, l >> 16, j1 >> 16);
				l += i2;
				j1 += j2;
			}
		...
		j -= k;
		for(k = lineOffsets[k]; --j >= 0; k += DrawingArea.width) {
			method506(DrawingArea.pixels, k, k1, 0, j1 >> 16, l >> 16);
			l += i2;
			j1 += j2;
		}
	...
	public static void method507(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2, int j2, int k2, int l2, int i3, int j3, int k3, int l3, int i4, int j4, int k4) {
		int ai[] = method500(k4);
		...
		if(i <= j && i <= k) {
			...
			if(j < k) {
				...
				if(i != j && i8 < i7 || i == j && i8 > k7) {
					...
					i = lineOffsets[i];
					while(--j >= 0) {
						method508(DrawingArea.pixels, ai, 0, 0, i, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
						j1 += i8;
						l += i7;
						i2 += j8;
						k1 += j7;
					...
					while(--k >= 0) {
						method508(DrawingArea.pixels, ai, 0, 0, i, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
						j1 += i8;
						i1 += k7;
						i2 += j8;
						l1 += l7;
				...
				i = lineOffsets[i];
				while(--j >= 0) {
					method508(DrawingArea.pixels, ai, 0, 0, i, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
					j1 += i8;
					l += i7;
					i2 += j8;
					k1 += j7;
				...
				while(--k >= 0) {
					method508(DrawingArea.pixels, ai, 0, 0, i, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
					j1 += i8;
					i1 += k7;
					i2 += j8;
					l1 += l7;
			...
			if(i != k && i8 < i7 || i == k && k7 > i7) {
				...
				i = lineOffsets[i];
				while(--k >= 0) {
					method508(DrawingArea.pixels, ai, 0, 0, i, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
					i1 += i8;
					l += i7;
					l1 += j8;
					k1 += j7;
			...
			i = lineOffsets[i];
			while(--k >= 0) {
				method508(DrawingArea.pixels, ai, 0, 0, i, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
				i1 += i8;
				l += i7;
				l1 += j8;
				k1 += j7;
		...
		if(j <= k) {
			...
			if(k < i) {
				...
				if(j != k && i7 < k7 || j == k && i7 > i8) {
					...
					j = lineOffsets[j];
					while(--k >= 0) {
						method508(DrawingArea.pixels, ai, 0, 0, j, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
						l += i7;
						i1 += k7;
						k1 += j7;
						l1 += l7;
					...
					while(--i >= 0) {
						method508(DrawingArea.pixels, ai, 0, 0, j, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
						l += i7;
						j1 += i8;
						k1 += j7;
						i2 += j8;
				...
				j = lineOffsets[j];
				while(--k >= 0) {
					method508(DrawingArea.pixels, ai, 0, 0, j, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
					l += i7;
					i1 += k7;
					k1 += j7;
					l1 += l7;
				...
				while(--i >= 0) {
					method508(DrawingArea.pixels, ai, 0, 0, j, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
					l += i7;
					j1 += i8;
					k1 += j7;
					i2 += j8;
			...
			if(i7 < k7) {
				...
				j = lineOffsets[j];
				while(--i >= 0) {
					method508(DrawingArea.pixels, ai, 0, 0, j, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
					j1 += i7;
					i1 += k7;
					i2 += j7;
					l1 += l7;
			...
			j = lineOffsets[j];
			while(--i >= 0) {
				method508(DrawingArea.pixels, ai, 0, 0, j, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
				j1 += i7;
				i1 += k7;
				i2 += j7;
				l1 += l7;
		...
		if(i < j) {
			...
			if(k7 < i8) {
				...
				k = lineOffsets[k];
				while(--i >= 0) {
					method508(DrawingArea.pixels, ai, 0, 0, k, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
					i1 += k7;
					j1 += i8;
					l1 += l7;
					i2 += j8;
				...
				while(--j >= 0) {
					method508(DrawingArea.pixels, ai, 0, 0, k, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
					i1 += k7;
					l += i7;
					l1 += l7;
					k1 += j7;
			...
			k = lineOffsets[k];
			while(--i >= 0) {
				method508(DrawingArea.pixels, ai, 0, 0, k, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
				i1 += k7;
				j1 += i8;
				l1 += l7;
				i2 += j8;
			...
			while(--j >= 0) {
				method508(DrawingArea.pixels, ai, 0, 0, k, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
				i1 += k7;
				l += i7;
				l1 += l7;
				k1 += j7;
		...
		if(k7 < i8) {
			...
			k = lineOffsets[k];
			while(--j >= 0) {
				method508(DrawingArea.pixels, ai, 0, 0, k, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
				l += k7;
				j1 += i8;
				k1 += l7;
				i2 += j8;
		...
		k = lineOffsets[k];
		while(--j >= 0) {
			method508(DrawingArea.pixels, ai, 0, 0, k, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
			l += k7;
			j1 += i8;
			k1 += l7;
			i2 += j8;
	...
	public static void method508(int ai[], int ai1[], int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2, int j2, int k2, int l2, int i3) {
		if(l >= i1)
			return;
		int j3;
		int k3;
