package com.runescape.cache.obj;
...
public class ObjectDefinitionParser {
	 ...
	 */
	public ObjectDefinitionParser(Cache cache, StandardIndex[] indices, CacheDefinitionListener listener) {
		this.cache = cache;
	...
	public void parse() throws IOException {
		...
		for(StandardIndex index : indices) {
			...
			String actions = " ";
			//BufferedWriter write = new BufferedWriter(new FileWriter("./npcActions.txt"));
			int sizeX = 1;
			int sizeY = 1;
	...
	outer_loop:
			do {
				...
				do {
					...
					case 37:
					case 38:
						actions = ByteBufferUtils.getString(buf); // actions
						//System.out.println(actions);
						//write.write("Npc: " + id + "; Actions: " + actions);
						//write.newLine();
						break;
					case 40:
