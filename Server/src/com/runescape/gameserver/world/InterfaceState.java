...
public class InterfaceState {
	...
	NumberInputListener numberInput;
	
	public NumberInputListener getNumberInputListener() {
		return numberInput;
	}
	
	public void setNumberInputListener(NumberInputListener listener) {
		this.numberInput = listener;
		player.getPacketSender().sendEnterAmountInterface();
	}
