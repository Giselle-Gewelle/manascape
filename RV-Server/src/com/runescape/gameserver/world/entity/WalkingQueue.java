...
import com.runescape.gameserver.pathfinder.AStarPathFinder;
...
public class WalkingQueue {
			...
			if(runPoint != null) {
			    if(mob instanceof Player) {
			        ...
			        if(player.getRunEnergy() <= 0) {
			        	...
			        	player.getPacketSender().sendConfig(InterfaceConfigs.RUNNING, 0);
			        }
			    }
			}
	 ...
	 */
	private Point getNextPoint(boolean run) {
		/*
	...
	public void walkTo(int xPos, int yPos) {
		walkTo(xPos, yPos, 32, false);
	}
