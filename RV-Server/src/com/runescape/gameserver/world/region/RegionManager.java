...
public class RegionManager {
	...
	public GameObject getObjectAtLocation(Location l) {
		Region[] regions = getSurroundingRegions(l);
		for (Region r : regions) {
			return r.getGameObject(l);
		}
		return null;
	}
	...
	/**
	 * Gets the players in the surrounding regions around an entity.
	 * @param entity The entity.
	 * @return The collection of players.
	 */
	public Collection<Player> getPlayersInSurroundingRegions(Mob entity) {
	...
	/**
	 * Gets the players in the same region another entity is in.
	 * @param entity The entity.
	 * @return The collection of players.
	 */
	public Collection<Player> getPlayersInRegion(Mob entity) {
		List<Player> players = new LinkedList<Player>();
		Region region = getRegionByLocation(entity.getLocation());
		for(Player player : region.getPlayers()) {
			players.add(player);
		}
		return Collections.unmodifiableCollection(players);
